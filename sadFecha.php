...
class fecha {
    ...
    public function incrementarAño($anio){
    ...
    public function __toString(){
        $cadena =$this->getDia()." de ".$this->numeroMes[($this->getMes())]." del año ".$this->getAnio()."\n ";
        return $cadena;
    }
}

$p= new fecha(25,8,2020);
...
echo "---------Fecha en forma abrebiada--------------"."\n";
echo $p->fechaEscrita();
echo "---------Fecha en forma escrita--------------"."\n";
$p->incrementarDias(1);
echo $p;
